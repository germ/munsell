...
func init() {
	...
	inputError = errors.New("Invalid or otherwise wonky input. Debug this library or your code.")
}

func ConvertBetween(input string) (conv string, err error) {
	...
	if strings.HasPrefix(input, "#") {
		...
		if !ok {
			...
			for i, v := range(dearGodICantProgram) {
				diff, err  := hexDiff(input[1:], i[1:])
				if err != nil { return "", inputError }
				if diff < bestScore {
					bestScore = diff
					bestMatch = v
				}
...
func hexDiff(h1, h2 string) (int, error) {
